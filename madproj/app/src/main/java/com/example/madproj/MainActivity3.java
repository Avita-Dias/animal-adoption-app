...
public class MainActivity3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                flag=true;
                insertData();
                Toast.makeText(MainActivity3.this, "Details submitted", Toast.LENGTH_LONG).show();
                ...
                public void onClick(View v) {
                    if(flag) {
                        final AlertDialog dialog = new AlertDialog.Builder(MainActivity3.this)
                                ...
                                .setMessage("Are you sure you want to adopt this dog?")
                        ...
                        positiveButton.setOnClickListener(new View.OnClickListener() {
                            @Override
                            public void onClick(View v) {
                                String dogname = textd.getText().toString();
                                deleteData(dogname);
                                launch2();
                                dialog.dismiss();
                            }
                        ...
                        Toast.makeText(MainActivity3.this,"Can't adopt without submitting the details",Toast.LENGTH_LONG).show();
                    }
    ...
    private void deleteData(String name){
        reference= FirebaseDatabase.getInstance().getReference("Dogdb");
