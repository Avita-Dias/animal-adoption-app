    ...
    protected void onBindViewHolder(@NonNull myviewholder holder, int position, @NonNull model model) {
        ...
        holder.img1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                activity.getSupportFragmentManager().beginTransaction().replace(R.id.wrapper,new detfragment(model.getAaname(),model.getAge(),model.getDetails(),model.getDtype(),model.getPurl())).addToBackStack(null).commit();
            }
        });
    }
